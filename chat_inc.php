...
class SimpleChat {
    ...
    function getMessages() {
        ...
        //select the database
        mysqli_select_db($vLink, $this->sDbName) or die(mysqli_error($vLink));;

        //returning the last 15 messages
        $vRes = mysqli_query($vLink,"SELECT * FROM `s_chat_messages` ORDER BY `id` ASC LIMIT 500");
